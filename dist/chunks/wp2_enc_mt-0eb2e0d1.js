var Module = (function () {
  ...
  return function (Module) {
    ...
    if (Module['locateFile']) {
      var wasmBinaryFile = 'wp2_enc_mt.wasm';
      if (!isDataURI(wasmBinaryFile)) {
        wasmBinaryFile = locateFile(wasmBinaryFile);
      }
    } else {
      var wasmBinaryFile = new URL(
        '../assets/wp2_enc_mt-1feb6658.wasm',
        import.meta.url,
      ).toString();
    }
      ...
      allocateUnusedWorker: function () {
        if (!Module['locateFile']) {
          PThread.unusedWorkers.push(
            new Worker(
              new URL('wp2_enc_mt.worker-724acf0e.js', import.meta.url),
            ),
          );
          return;
        }
        var pthreadMainJs = locateFile('wp2_enc_mt.worker.js');
    ...
    Module['dynCall_jiji'] = function () {
      return (Module['dynCall_jiji'] = Module['asm']['oa']).apply(
        null,
        arguments,
      );
    };
