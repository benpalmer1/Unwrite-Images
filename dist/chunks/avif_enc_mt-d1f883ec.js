var Module = (function () {
  ...
  return function (Module) {
    ...
    function UTF8ToString(ptr, maxBytesToRead) {
      ...
      for (var end = ptr; !(end >= maxPtr) && GROWABLE_HEAP_U8()[end]; ) ++end;
      return UTF8Decoder.decode(GROWABLE_HEAP_U8().subarray(ptr, end));
    }
    ...
    var UTF16Decoder = new TextDecoderWrapper('utf-16le');
    ...
    if (Module['locateFile']) {
      ...
      wasmBinaryFile = new URL(
        '../assets/avif_enc_mt-9d34100e.wasm',
        import.meta.url,
      ).toString();
    }
      ...
      allocateUnusedWorker: function () {
        if (!Module['locateFile']) {
          PThread.unusedWorkers.push(
            new Worker(
              new URL('avif_enc_mt.worker-4a316f39.js', import.meta.url),
            ),
          );
          return;
        }
    ...
    var asmLibraryArg = {
      ...
      z: ___pthread_create_js,
      X: ___pthread_detached_exit,
      V: ___pthread_join_js,
    ...
    Module['___wasm_call_ctors'] = function () {
      return (Module['___wasm_call_ctors'] = Module['asm']['ka']).apply(
        null,
        arguments,
      );
    };
    ...
    Module['_emscripten_tls_init'] = function () {
      return (Module['_emscripten_tls_init'] = Module['asm']['na']).apply(
        null,
        arguments,
      );
    };
    ...
    var _setThrew = (Module['_setThrew'] = function () {
      return (_setThrew = Module['_setThrew'] = Module['asm']['Ea']).apply(
        null,
        arguments,
      );
    });
    var _memalign = (Module['_memalign'] = function () {
      return (_memalign = Module['_memalign'] = Module['asm']['Fa']).apply(
        null,
        arguments,
      );
    });
    Module['dynCall_jiiiiiiiii'] = function () {
      return (Module['dynCall_jiiiiiiiii'] = Module['asm']['Ha']).apply(
        null,
        arguments,
      );
    };
    ...
    Module['dynCall_jiji'] = function () {
      return (Module['dynCall_jiji'] = Module['asm']['Ja']).apply(
        null,
        arguments,
      );
    };
    Module['dynCall_jiiiiiiii'] = function () {
      return (Module['dynCall_jiiiiiiii'] = Module['asm']['Ka']).apply(
        null,
        arguments,
      );
    };
    Module['dynCall_jiiiiii'] = function () {
      return (Module['dynCall_jiiiiii'] = Module['asm']['La']).apply(
        null,
        arguments,
      );
    };
    Module['dynCall_jiiiii'] = function () {
      return (Module['dynCall_jiiiii'] = Module['asm']['Ma']).apply(
        null,
        arguments,
      );
    };
    Module['dynCall_iiijii'] = function () {
      return (Module['dynCall_iiijii'] = Module['asm']['Na']).apply(
        null,
        arguments,
      );
    };
