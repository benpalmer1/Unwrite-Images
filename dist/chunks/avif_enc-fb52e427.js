var Module = (function () {
  ...
  return function (Module) {
    ...
    var asmLibraryArg = {
      ...
      M: ___syscall_ioctl,
      O: ___syscall_open,
      D: __embind_finalize_value_object,
      ...
      q: invoke_viiiiiiiiiii,
      a: _setTempRet0,
      w: _time,
    };
    createWasm();
    Module['___wasm_call_ctors'] = function () {
      return (Module['___wasm_call_ctors'] = Module['asm']['U']).apply(
        null,
        arguments,
      );
    };
    ...
    var stackSave = (Module['stackSave'] = function () {
      return (stackSave = Module['stackSave'] = Module['asm']['Z']).apply(
        null,
        arguments,
      );
    });
    var stackRestore = (Module['stackRestore'] = function () {
      return (stackRestore = Module['stackRestore'] = Module['asm']['_']).apply(
        null,
        arguments,
      );
    });
    ...
    Module['dynCall_jiiiiiiiii'] = function () {
      return (Module['dynCall_jiiiiiiiii'] = Module['asm']['ba']).apply(
        null,
        arguments,
      );
    };
    ...
    Module['dynCall_jiji'] = function () {
      return (Module['dynCall_jiji'] = Module['asm']['da']).apply(
        null,
        arguments,
      );
    };
    Module['dynCall_jiiiiiiii'] = function () {
      return (Module['dynCall_jiiiiiiii'] = Module['asm']['ea']).apply(
        null,
        arguments,
      );
    };
    Module['dynCall_jiiiiii'] = function () {
      return (Module['dynCall_jiiiiii'] = Module['asm']['fa']).apply(
        null,
        arguments,
      );
    };
    Module['dynCall_jiiiii'] = function () {
      return (Module['dynCall_jiiiii'] = Module['asm']['ga']).apply(
        null,
        arguments,
      );
    };
    Module['dynCall_iiijii'] = function () {
      return (Module['dynCall_iiijii'] = Module['asm']['ha']).apply(
        null,
        arguments,
      );
    };
