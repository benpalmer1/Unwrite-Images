var Module = (function () {
  ...
  return function (Module) {
    ...
    Module['___wasm_call_ctors'] = function () {
      return (Module['___wasm_call_ctors'] = Module['asm']['F']).apply(
        null,
        arguments,
      );
    };
    ...
    var stackSave = (Module['stackSave'] = function () {
      return (stackSave = Module['stackSave'] = Module['asm']['K']).apply(
        null,
        arguments,
      );
    });
    var stackRestore = (Module['stackRestore'] = function () {
      return (stackRestore = Module['stackRestore'] = Module['asm']['L']).apply(
        null,
        arguments,
      );
    });
    var _setThrew = (Module['_setThrew'] = function () {
      return (_setThrew = Module['_setThrew'] = Module['asm']['M']).apply(
        null,
        arguments,
      );
    });
    Module['dynCall_iiijii'] = function () {
      return (Module['dynCall_iiijii'] = Module['asm']['O']).apply(
        null,
        arguments,
      );
    };
    Module['dynCall_jiji'] = function () {
      return (Module['dynCall_jiji'] = Module['asm']['P']).apply(
        null,
        arguments,
      );
    };
