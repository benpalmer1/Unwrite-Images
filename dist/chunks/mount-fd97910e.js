...
function k(l) {
  ((!l.__d && (l.__d = !0) && u.push(l) && !g.__r++) ||
    t$1 !== n.debounceRendering) &&
    ((t$1 = n.debounceRendering) || i$1)(g);
}
function g() {
    ...
    n: if ('function' == typeof P) {
      if (
        ...
        null != P.getDerivedStateFromProps &&
          ...
          s$1(h.__s, P.getDerivedStateFromProps(g, h.__s))),
        (y = h.props),
        (_ = h.state),
        v)
      )
      ...
      (h.context = x),
        ...
        v ||
          ...
          (w = h.getSnapshotBeforeUpdate(y, _)),
...
function H(n, l, u, i, t, o, r, c) {
  ...
  if (null === l.type) p === d || (c && n.data === d) || (n.data = d);
    ...
    if (
      (null != o && (o = e$1.slice.call(n.childNodes)),
...
class i extends Event {
  constructor(t, e) {
    var s, r;
    super(t, e),
      (s = this) instanceof (r = i) || Object.setPrototypeOf(s, r.prototype),
      (this._files = e.files),
...
class s extends HTMLElement {
  constructor() {
    super(),
      ...
      this.addEventListener('dragover', (t) => t.preventDefault()),
  ...
  _onDragEnter(e) {
    ...
    this.classList.add(
      !e.dataTransfer || !e.dataTransfer.items.length || void 0 !== i[0]
        ? 'drop-valid'
        : 'drop-invalid',
    );
  }
  ...
  _onDrop(t) {
    ...
    void 0 !== s &&
      this.dispatchEvent(new i('filedrop', { action: 'drop', files: s }));
  }
  _onPaste(t) {
    if (!t.clipboardData) return;
    const s = e(t.clipboardData, this.accept, void 0 !== this.multiple);
    void 0 !== s &&
      this.dispatchEvent(new i('filedrop', { action: 'paste', files: s }));
  }
  _reset() {
    (this._dragEnterCount = 0),
...
const footerLinkWithLogo =
  '_footer-link-with-logo_epfhz_529 _footer-link_epfhz_519';
    ...
    return h(
      ...
      h(
        ...
        h(
          ...
          h(
            'div',
            { class: loadImgContent, style: { visibility: '' } },
            h(
              'button',
              { class: loadBtn, onClick: this.onOpenClick },
              h(
                'svg',
                { viewBox: '0 0 24 24', class: loadIcon },
                h('path', {
            ...
            h(
              ...
              supportsClipboardAPI
                ? h(
                    'button',
                    { class: pasteBtn, onClick: this.onPasteClick },
                    'Paste',
                  )
                : 'Paste',
            ),
      ...
      h(
        'div',
        { class: demosContainer },
        h(
          'svg',
          { viewBox: '0 0 1920 140', class: topWave },
          h('path', {
      ...
      h(
        ...
        h(
          'svg',
          { viewBox: '0 0 1920 79', class: topWave },
          h('path', {
            ...
            h(
              ...
              h(
                ...
                h(
                  'p',
                  { class: infoCaption },
                  'Smaller images mean faster load times. Unwrite Images can reduce file size while maintaining high quality.',
                ),
              ),
              h(
                'div',
                { class: infoImgWrapper },
                h('img', {
                  class: infoImg,
            ...
            h(
              ...
              h(
                ...
                h(
                  'p',
                  { class: infoCaption },
                  'Worried about privacy? Images never leave your device since Unwrite Images does all the work locally.',
                ),
              ),
              h(
                'div',
          ...
          h(
            ...
            h(
              ...
              h(
                ...
                {
                  class: footerLink,
                  href: 'https://unwrite.co/images/privacy',
                },
                'Privacy',
              ),
              h(
                'a',
                {
                  class: footerLinkWithLogo,
                  href: 'https://github.com/benpalmer1/Unwrite-Images',
                },
                h('img', {
                  src: githubLogo,
                  alt: '',
      ...
      beforeInstallEvent &&
        h(
          'button',
          { class: installBtn, onClick: this.onInstallClick },
          'Install',
        ),
    );
  }
...
class App extends d {
  ...
  render({}, { file, isEditorOpen, Compress, awaitingShareTarget }) {
    ...
    return h(
      ...
      h(
        'file-drop',
        { onfiledrop: this.onFileDrop, class: drop },
        showSpinner
          ? h('loading-spinner', { class: appLoader })
          : isEditorOpen
          ? Compress &&
            h(Compress, { file: file, showSnack: this.showSnack, onBack: back })
          : h(Intro, {
