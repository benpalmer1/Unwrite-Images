var Module = (function () {
  ...
  return function (Module) {
    ...
    if (Module['locateFile']) {
      var wasmBinaryFile = 'wp2_enc_mt_simd.wasm';
      if (!isDataURI(wasmBinaryFile)) {
        wasmBinaryFile = locateFile(wasmBinaryFile);
      }
    } else {
      var wasmBinaryFile = new URL(
        '../assets/wp2_enc_mt_simd-0b0595e9.wasm',
        import.meta.url,
      ).toString();
    }
      ...
      allocateUnusedWorker: function () {
        if (!Module['locateFile']) {
          PThread.unusedWorkers.push(
            new Worker(
              new URL('wp2_enc_mt_simd.worker-812c83c2.js', import.meta.url),
            ),
          );
          return;
        }
        var pthreadMainJs = locateFile('wp2_enc_mt_simd.worker.js');
    ...
    var asmLibraryArg = {
      ...
      F: _emscripten_webgl_create_context,
      I: _fd_close,
      x: _fd_seek,
      H: _fd_write,
      z: initPthreadsJS,
    ...
    Module['___wasm_call_ctors'] = function () {
      return (Module['___wasm_call_ctors'] = Module['asm']['S']).apply(
        null,
        arguments,
      );
    };
    ...
    Module['_emscripten_tls_init'] = function () {
      return (Module['_emscripten_tls_init'] = Module['asm']['V']).apply(
        null,
        arguments,
      );
    };
    ...
    var stackSave = (Module['stackSave'] = function () {
      return (stackSave = Module['stackSave'] = Module['asm']['ja']).apply(
        null,
        arguments,
      );
    });
    ...
    var stackAlloc = (Module['stackAlloc'] = function () {
      return (stackAlloc = Module['stackAlloc'] = Module['asm']['la']).apply(
        null,
        arguments,
      );
    });
    ...
    var _memalign = (Module['_memalign'] = function () {
      return (_memalign = Module['_memalign'] = Module['asm']['na']).apply(
        null,
        arguments,
      );
    });
    Module['dynCall_jiii'] = function () {
      return (Module['dynCall_jiii'] = Module['asm']['oa']).apply(
        null,
        arguments,
      );
    };
    Module['dynCall_jiiiiii'] = function () {
      return (Module['dynCall_jiiiiii'] = Module['asm']['pa']).apply(
        null,
        arguments,
      );
    };
    Module['dynCall_jiji'] = function () {
      return (Module['dynCall_jiji'] = Module['asm']['qa']).apply(
        null,
        arguments,
      );
    };
