...
const options1 =
  '_options-1_105bw_85 _options_105bw_43 _options-1-theme_105bw_85';
const options2 =
  '_options-2_105bw_111 _options_105bw_43 _options-2-theme_105bw_111';
...
const copyOverButton =
  '_copy-over-button_rjr20_243 _title-button_rjr20_207 unbutton';
const saveButton = '_save-button_rjr20_275 _title-button_rjr20_207 unbutton';
const importButton =
  '_import-button_rjr20_277 _title-button_rjr20_207 unbutton';
...
const ToggleAliasingIcon = (props) =>
  h(
    Icon,
    { ...props },
    h('circle', {
...
const ToggleAliasingActiveIcon = (props) =>
  h(
    Icon,
    { ...props },
    h('path', {
...
const ToggleBackgroundIcon = (props) =>
  h(
    Icon,
    { ...props },
    h('path', {
...
const ToggleBackgroundActiveIcon = (props) =>
  h(
    Icon,
    { ...props },
    h('path', {
...
const RemoveIcon = (props) =>
  h(Icon, { ...props }, h('path', { d: 'M19 13H5v-2h14v2z' }));
...
class Checkbox extends d {
  render(props) {
    return h(
      ...
      props.checked
        ? props.disabled
          ? h(CheckedIcon, { class: `${icon} ${disabled}` })
          : h(CheckedIcon, { class: `${icon} ${checked}` })
        : h(UncheckedIcon, { class: icon }),
...
class Expander extends d {
  ...
  render({}, { children, outgoingChildren }) {
    return h(
      'div',
      { class: outgoingChildren ? childrenExiting : '' },
...
class Select extends d {
  render(props) {
    ...
    return h(
      ...
      { class: select },
      h('select', {
        class: `${builtinSelect} ${large$1 ? large : ''}`,
        ...otherProps,
      }),
      h('div', { class: arrow$1 }, h(Arrow, null)),
    );
  }
}
  ...
  return (
    ...
    (u[e + n] = function (e) {
      for (
        ...
        c = c[o[a]] || (c[o[a]] = (!a && t.state[o[a]]) || {});
      (c[o[a]] = s), t.setState(i);
    })
  );
}
...
class Revealer extends d {
  render(props) {
    return h(
      ...
      h('div', { class: arrow }, h(Arrow, null)),
    );
  }
}

const encode$9 = (signal, workerBridge, imageData, options) =>
...
class Options$9 extends d {
  ...
  render(
    ...
    return h(
      'form',
      { class: optionsSection, onSubmit: preventDefault },
      h(
        'label',
        { class: optionToggle },
        'Lossless',
...
const encode$8 = (signal, workerBridge, imageData, options) =>
  canvasEncode(imageData, mimeType$8);
...
const encode$7 = (signal, workerBridge, imageData, options) =>
  canvasEncode(imageData, mimeType$7, options.quality);
...
const encode$6 = (signal, workerBridge, imageData, options) =>
  canvasEncode(imageData, mimeType$6);
...
const encode$5 = (signal, workerBridge, imageData, options) =>
...
const encode$1 = (signal, workerBridge, imageData, options) =>
  ...
  constructor() {
    ...
    this.onChange = (event) => {
      ...
      const newOptions = {
        ...
        image_hint: inputFieldCheckedAsNumber(
          form.image_hint,
          options.image_hint,
        )
          ? 3 /* WEBP_HINT_GRAPH */
        ...
        partitions: inputFieldValueAsNumber(
          form.partitions,
          options.partitions,
        ),
      };
  ...
  _losslessSpecificOptions(options) {
    return h(
      ...
      h(
        ...
        h(Checkbox, {
          name: 'image_hint',
          checked: options.image_hint === 3 /* WEBP_HINT_GRAPH */,
          onChange: this.onChange,
        }),
      ),
    );
...
const encode = (signal, workerBridge, imageData, options) =>
...
class Output extends d {
  ...
  render(
    { mobileView, leftImgContain, rightImgContain, source },
    { scale, editingScale, altBackground: altBackground$1, aliasing },
  ) {
    const leftDraw = this.leftDrawable();
    const rightDraw = this.rightDrawable();
    ...
    return h(
      ...
      h(
        'div',
        { class: `${output} ${altBackground$1 ? altBackground : ''}` },
        h(
          'two-up',
          {
            'legacy-clip-compat': true,
            class: twoUp,
          ...
          h(
            ...
            h('canvas', {
              class: `${pinchTarget} ${aliasing ? pixelated : ''}`,
          ...
          h(
            'pinch-zoom',
            { class: pinchZoom, ref: linkRef(this, 'pinchZoomRight') },
            h('canvas', {
              class: `${pinchTarget} ${aliasing ? pixelated : ''}`,
      ...
      h(
        ...
        h(
          ...
          h(
            'button',
            { class: firstButton, onClick: this.zoomOut },
            h(RemoveIcon, null),
          ),
          editingScale
            ? h('input', {
            ...
            : h(
                'span',
                { class: zoom, tabIndex: 0, onFocus: this.onScaleValueFocus },
                h('span', { class: zoomValue }, Math.round(scale * 100)),
                '%',
              ),
          h(
            'button',
            { class: lastButton, onClick: this.zoomIn },
            h(AddIcon, null),
          ),
        ),
        h(
          ...
          !isSafari &&
            h(
              ...
              aliasing
                ? h(ToggleAliasingActiveIcon, null)
                : h(ToggleAliasingIcon, null),
            ),
          h(
            'button',
            {
            ...
            altBackground$1
              ? h(ToggleBackgroundActiveIcon, null)
              : h(ToggleBackgroundIcon, null),
          ),
        ),
      ),
    );
  ...
  render(props) {
    return h(
      ...
      h(
        'div',
        { class: track },
        h('div', { class: thumbTrack }, h('div', { class: thumb })),
      ),
    );
  }
}
      ...
      h(
        ...
        extendedSettings
          ? h(
              ...
              h(
                Select,
                { name: 'zx', value: '' + options.zx, onChange: this.onChange },
...
function browserResize(data, opts) {
  ...
  return builtinResize(
    ...
    opts.width,
    opts.height,
    opts.method.slice('browser-'.length),
  );
}
      ...
      h(
        ...
        h(
          ...
          sizePresets.map((preset) =>
            h('option', { value: preset }, preset * 100, '%'),
          ),
...
class Options extends d {
  ...
  render({ source, encoderState, processorState }, { supportedEncoderMap }) {
    ...
    return h(
      'div',
      { class: optionsScroller + ' ' + (encoderState ? '' : originalImage) },
      h(
        Expander,
        null,
        !encoderState
          ...
          : h(
              ...
              h(
                ...
                h(
                  'div',
                  { class: titleAndButtons },
                  'Edit',
                  h(
                    'button',
                    {
                      class: copyOverButton,
      ...
      h(
        'section',
        { class: `${optionOneCell} ${optionsSection}` },
        supportedEncoderMap
          ? h(
              Select,
              {
              ...
              Object.entries(supportedEncoderMap).map(([type, encoder]) =>
                h('option', { value: type }, encoder.meta.label),
              ),
            )
          : h(Select, { large: true }, h('option', null, 'Loading\u2026')),
      ),
      h(
        Expander,
        null,
        EncoderOptionComponent &&
          h(EncoderOptionComponent, {
            options:
...
var css$1 =
  '._panel-content_156to_7{height:0;overflow:auto}._panel-content_156to_7[aria-expanded=true]{height:auto}';
...
class Results extends d {
  ...
  render(
    { source, imageFile, downloadUrl, flipSide, typeLabel: typeLabel$1 },
    { showLoadingState },
  ) {
    ...
    return h(
      ...
      {
        class:
          (flipSide ? resultsRight : resultsLeft) +
          ' ' +
          (isOriginal$1 ? isOriginal : ''),
      },
      h('div', { class: expandArrow }, h(Arrow, null)),
      h(
        'div',
        { class: bubble },
        h(
            ...
            h(
              ...
              prettySize
                ? h(
                    ...
                    h('span', { class: typeLabel }, ' ', typeLabel$1),
                  )
                : '…',
            ),
          ),
          h(
            ...
            h(
              ...
              diff &&
                diff !== 1 &&
                h('span', { class: sizeDirection }, diff < 1 ? '↓' : '↑'),
      ...
      h(
        'a',
        {
          class: showLoadingState ? downloadDisable : download,
          href: downloadUrl,
        ...
        h(
          'svg',
          { class: downloadBlobs, viewBox: '0 0 89.6 86.9' },
        ...
        h('div', { class: downloadIcon }, h(DownloadIcon, null)),
...
class Compress extends d {
  ...
  componentDidUpdate(prevProps, prevState) {
    ...
    if (wasLoading !== isLoading || sourceChanged) {
      updateDocumentTitle({
        loading: isLoading,
        filename:
          (_a = this.state.source) === null || _a === void 0
            ? void 0
            : _a.file.name,
      });
    }
  ...
  async updateImage() {
    ...
    const latestSideJobStates = currentState.sides.map(
      (side, i) =>
  ...
  render(
    { onBack },
    { loading, sides, source, mobileView, preprocessorState },
  ) {
    const [leftSide, rightSide] = sides;
    const [leftImageData, rightImageData] = sides.map((i) => i.data);
    const options$1 = sides.map((side, index) =>
      h(Options, {
        index: index,
        source: source,
    ...
    const results = sides.map((side, index) =>
      h(Results, {
        ...
        typeLabel: side.latestSettings.encoderState
    ...
    return h(
      ...
      mobileView
        ? h(
            ...
            h(
              'multi-panel',
              { class: multiPanel, 'open-one-only': true },
        ...
        : [
            h(
              'div',
              { class: options1, key: 'options1' },
              options$1[0],
              results[0],
            ),
            h(
              'div',
              { class: options2, key: 'options2' },
              options$1[1],
              results[1],
            ),
          ],
