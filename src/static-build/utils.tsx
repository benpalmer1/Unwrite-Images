...
export const siteOrigin = (() => {
  ...
  if (process.env.CONTEXT === 'production') return 'https://unwrite.co/images';
  if (process.env.DEPLOY_PRIME_URL) return process.env.DEPLOY_PRIME_URL;
  console.warn(
    'Unable to determine site origin, defaulting to https://unwrite.co/images',
  );
  return 'https://unwrite.co/images';
})();
