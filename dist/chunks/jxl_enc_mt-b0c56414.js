var Module = (function () {
  ...
  return function (Module) {
    ...
    if (Module['locateFile']) {
      var wasmBinaryFile = 'jxl_enc_mt.wasm';
      if (!isDataURI(wasmBinaryFile)) {
        wasmBinaryFile = locateFile(wasmBinaryFile);
      }
    } else {
      var wasmBinaryFile = new URL(
        '../assets/jxl_enc_mt-669d03c7.wasm',
        import.meta.url,
      ).toString();
    }
    ...
    function createWasm() {
      ...
      function receiveInstance(instance, module) {
        ...
        PThread.tlsInitFunctions.push(Module['asm']['ba']);
        wasmModule = module;
        if (!ENVIRONMENT_IS_PTHREAD) {
      ...
      allocateUnusedWorker: function () {
        if (!Module['locateFile']) {
          PThread.unusedWorkers.push(
            new Worker(
              new URL('jxl_enc_mt.worker-b6474779.js', import.meta.url),
            ),
          );
          return;
        }
    ...
    Module['___wasm_call_ctors'] = function () {
      return (Module['___wasm_call_ctors'] = Module['asm']['_']).apply(
        null,
        arguments,
      );
    };
    ...
    Module['_emscripten_tls_init'] = function () {
      return (Module['_emscripten_tls_init'] = Module['asm']['ba']).apply(
        null,
        arguments,
      );
    };
    ...
    var _memalign = (Module['_memalign'] = function () {
      return (_memalign = Module['_memalign'] = Module['asm']['wa']).apply(
        null,
        arguments,
      );
    });
    Module['dynCall_jiji'] = function () {
      return (Module['dynCall_jiji'] = Module['asm']['xa']).apply(
        null,
        arguments,
      );
    };
    Module['dynCall_iiji'] = function () {
      return (Module['dynCall_iiji'] = Module['asm']['ya']).apply(
        null,
        arguments,
      );
    };
    Module['dynCall_iiiiij'] = function () {
      return (Module['dynCall_iiiiij'] = Module['asm']['za']).apply(
        null,
        arguments,
      );
    };
    Module['dynCall_iiiiijj'] = function () {
      return (Module['dynCall_iiiiijj'] = Module['asm']['Aa']).apply(
        null,
        arguments,
      );
    };
    Module['dynCall_iiiiiijj'] = function () {
      return (Module['dynCall_iiiiiijj'] = Module['asm']['Ba']).apply(
        null,
        arguments,
      );
    };
    Module['dynCall_viijii'] = function () {
      return (Module['dynCall_viijii'] = Module['asm']['Ca']).apply(
        null,
        arguments,
      );
    };
...
//# sourceMappingURL=jxl_enc_mt-b0c56414.js.map
