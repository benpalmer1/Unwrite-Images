import { g as getContainOffsets, e as expose } from './util-b67af3de.js';
 ...
 * limitations under the License.
 */
function initEmscriptenModule(moduleFactory) {
...
let emscriptenModule$b;
async function decode$4(blob) {
  if (!emscriptenModule$b) {
    const decoder = await import('./avif_dec-7490cdf3.js');
    emscriptenModule$b = initEmscriptenModule(decoder.default);
  }
...
var Module$5 = (function () {
  ...
  return function (Module) {
    ...
    Module['___wasm_call_ctors'] = function () {
      return (Module['___wasm_call_ctors'] = Module['asm']['y']).apply(
        null,
        arguments,
      );
    };
    ...
    Module['dynCall_iiji'] = function () {
      return (Module['dynCall_iiji'] = Module['asm']['E']).apply(
        null,
        arguments,
      );
    };
    Module['dynCall_jiji'] = function () {
      return (Module['dynCall_jiji'] = Module['asm']['F']).apply(
        null,
        arguments,
      );
    };
 ...
 * limitations under the License.
 */
let emscriptenModule$a;
async function decode$3(blob) {
  if (!emscriptenModule$a) {
    emscriptenModule$a = initEmscriptenModule(Module$5);
  }
  const [module, data] = await Promise.all([
    emscriptenModule$a,
    blobToArrayBuffer(blob),
...
var Module$4 = (function () {
  ...
  return function (Module) {
    ...
    if (Module['locateFile']) {
      var wasmBinaryFile = 'qoi_dec.wasm';
      if (!isDataURI(wasmBinaryFile)) {
        wasmBinaryFile = locateFile(wasmBinaryFile);
      }
    } else {
      var wasmBinaryFile = new URL(
        '../assets/qoi_dec-3728a8ee.wasm',
        import.meta.url,
      ).toString();
    }
    function getBinary(file) {
    ...
    createWasm();
    Module['___wasm_call_ctors'] = function () {
      return (Module['___wasm_call_ctors'] = Module['asm']['t']).apply(
        null,
        arguments,
      );
    };
...
let emscriptenModule$9;
async function decode$2(blob) {
  if (!emscriptenModule$9) {
    emscriptenModule$9 = initEmscriptenModule(Module$4);
  }
  const [module, data] = await Promise.all([
    emscriptenModule$9,
    blobToArrayBuffer(blob),
...
let emscriptenModule$8;
async function decode$1(blob) {
  if (!emscriptenModule$8) {
    const decoder = await import('./webp_dec-13d19d29.js');
    emscriptenModule$8 = initEmscriptenModule(decoder.default);
  }
  const [module, data] = await Promise.all([
    emscriptenModule$8,
    blobToArrayBuffer(blob),
...
var Module$3 = (function () {
  ...
  return function (Module) {
    ...
    if (Module['locateFile']) {
      var wasmBinaryFile = 'wp2_dec.wasm';
      if (!isDataURI(wasmBinaryFile)) {
        wasmBinaryFile = locateFile(wasmBinaryFile);
      }
    } else {
      var wasmBinaryFile = new URL(
        '../assets/wp2_dec-9a40adf1.wasm',
        import.meta.url,
      ).toString();
    }
    function getBinary(file) {
    ...
    var _free = (Module['_free'] = function () {
      return (_free = Module['_free'] = Module['asm']['y']).apply(
        null,
        arguments,
      );
    });
    ...
    Module['dynCall_jiji'] = function () {
      return (Module['dynCall_jiji'] = Module['asm']['D']).apply(
        null,
        arguments,
      );
    };
 ...
 * limitations under the License.
 */
let emscriptenModule$7;
async function decode(blob) {
  if (!emscriptenModule$7) {
    emscriptenModule$7 = initEmscriptenModule(Module$3);
  }
  const [module, data] = await Promise.all([
    emscriptenModule$7,
    blobToArrayBuffer(blob),
...
async function checkThreadsSupport() {
  ...
  // This meant Unwrite Images failed in Safari 16, since we call our wasm from inside a worker to begin with.
...
let emscriptenModule$6;
async function init$6() {
  if (await checkThreadsSupport()) {
    const avifEncoder = await import('./avif_enc_mt-d1f883ec.js');
    return initEmscriptenModule(avifEncoder.default);
  }
  const avifEncoder = await import('./avif_enc-fb52e427.js');
  return initEmscriptenModule(avifEncoder.default);
}
async function encode$6(data, options) {
  if (!emscriptenModule$6) emscriptenModule$6 = init$6();
  const module = await emscriptenModule$6;
  const result = module.encode(data.data, data.width, data.height, options);
  if (!result) throw new Error('Encoding error');
  return result.buffer;
}

let emscriptenModule$5;
async function init$5() {
  if (await checkThreadsSupport()) {
    if (await simd()) {
      const jxlEncoder = await import('./jxl_enc_mt_simd-26f417aa.js');
      return initEmscriptenModule(jxlEncoder.default);
    }
    const jxlEncoder = await import('./jxl_enc_mt-b0c56414.js');
    return initEmscriptenModule(jxlEncoder.default);
  }
  const jxlEncoder = await import('./jxl_enc-ce626f69.js');
  return initEmscriptenModule(jxlEncoder.default);
}
async function encode$5(data, options) {
  if (!emscriptenModule$5) emscriptenModule$5 = init$5();
  const module = await emscriptenModule$5;
  const result = module.encode(data.data, data.width, data.height, options);
  if (!result) throw new Error('Encoding error.');
  return result.buffer;
}
...
var Module$2 = (function () {
  ...
  return function (Module) {
    ...
    if (Module['locateFile']) {
      ...
      var wasmBinaryFile = new URL(
        '../assets/mozjpeg_enc-f6bf569c.wasm',
        import.meta.url,
      ).toString();
    }
    function getBinary(file) {
    ...
    createWasm();
    Module['___wasm_call_ctors'] = function () {
      return (Module['___wasm_call_ctors'] = Module['asm']['D']).apply(
        null,
        arguments,
      );
    };
    ...
    Module['dynCall_jiji'] = function () {
      return (Module['dynCall_jiji'] = Module['asm']['J']).apply(
        null,
        arguments,
      );
    };
 ...
 * limitations under the License.
 */
let emscriptenModule$4;
async function encode$4(data, options) {
  if (!emscriptenModule$4) {
    emscriptenModule$4 = initEmscriptenModule(Module$2);
  }
  const module = await emscriptenModule$4;
...
async function initMT() {
  const {
    ...
    initThreadPool,
    optimise,
  } = await import('./squoosh_oxipng-cef97fb8.js');
  await init();
...
async function encode$3(data, options) {
  if (!wasmReady) {
    wasmReady = checkThreadsSupport().then((hasThreads) =>
...
var Module$1 = (function () {
  ...
  return function (Module) {
    ...
    if (Module['locateFile']) {
      var wasmBinaryFile = 'qoi_enc.wasm';
      if (!isDataURI(wasmBinaryFile)) {
        wasmBinaryFile = locateFile(wasmBinaryFile);
      }
    } else {
      var wasmBinaryFile = new URL(
        '../assets/qoi_enc-9285b08c.wasm',
        import.meta.url,
      ).toString();
    }
    function getBinary(file) {
    ...
    createWasm();
    Module['___wasm_call_ctors'] = function () {
      return (Module['___wasm_call_ctors'] = Module['asm']['v']).apply(
        null,
        arguments,
      );
    };
    ...
    var _free = (Module['_free'] = function () {
      return (_free = Module['_free'] = Module['asm']['x']).apply(
        null,
        arguments,
      );
    });
 ...
 * limitations under the License.
 */
let emscriptenModule$3;
async function init$4() {
  return initEmscriptenModule(Module$1);
}
async function encode$2(data, options) {
  if (!emscriptenModule$3) {
    emscriptenModule$3 = init$4();
  }
  const module = await emscriptenModule$3;
  const resultView = module.encode(data.data, data.width, data.height, options);
  // wasm can’t run on SharedArrayBuffers, so we hard-cast to ArrayBuffer.
  return resultView.buffer;
}

let emscriptenModule$2;
async function init$3() {
  if (await simd()) {
    const webpEncoder = await import('./webp_enc_simd-d289dea9.js');
    return initEmscriptenModule(webpEncoder.default);
  }
  const webpEncoder = await import('./webp_enc-60d311a9.js');
  return initEmscriptenModule(webpEncoder.default);
}
async function encode$1(data, options) {
  if (!emscriptenModule$2) emscriptenModule$2 = init$3();
  const module = await emscriptenModule$2;
  const result = module.encode(data.data, data.width, data.height, options);
  if (!result) throw new Error('Encoding error.');
  return result.buffer;
}
...
async function init$2() {
  if (await checkThreadsSupport()) {
    if (await simd()) {
      const wp2Encoder = await import('./wp2_enc_mt_simd-421085aa.js');
      return initEmscriptenModule(wp2Encoder.default);
    }
    const wp2Encoder = await import('./wp2_enc_mt-0eb2e0d1.js');
    return initEmscriptenModule(wp2Encoder.default);
  }
  const wp2Encoder = await import('./wp2_enc-18a66c7f.js');
  return initEmscriptenModule(wp2Encoder.default);
}
async function encode(data, options) {
  if (!emscriptenModule$1) emscriptenModule$1 = init$2();
...
var wasmUrl = '../assets/rotate-e8fb6784.wasm';
...
async function rotate(data, opts) {
  const instance = (await instancePromise).instance;
...
var Module = (function () {
  ...
  return function (Module) {
    ...
    if (Module['locateFile']) {
      var wasmBinaryFile = 'imagequant.wasm';
      if (!isDataURI(wasmBinaryFile)) {
        wasmBinaryFile = locateFile(wasmBinaryFile);
      }
    } else {
      var wasmBinaryFile = new URL(
        '../assets/imagequant-a10bbe1a.wasm',
        import.meta.url,
      ).toString();
    }
    function getBinary(file) {
...
async function process(data, opts) {
  if (!emscriptenModule) {
    emscriptenModule = initEmscriptenModule(Module);
  }
...
function getUint8ClampedMemory0() {
  if (
    ...
    cachegetUint8ClampedMemory0.buffer !== wasm$1.memory.buffer
  ) {
...
async function init$1(input) {
  if (typeof input === 'undefined') {
    input = new URL(
      '../assets/squoosh_resize_bg-3d426466.wasm',
      import.meta.url,
    );
  }
  const imports = {};
...
async function init(input) {
  if (typeof input === 'undefined') {
    input = new URL('../assets/squooshhqx_bg-6e04a330.wasm', import.meta.url);
  }
  const imports = {};
...
const exports = {
  avifDecode(...args) {
    return timed('avifDecode', () => decode$4(...args));
  },
  jxlDecode(...args) {
    return timed('jxlDecode', () => decode$3(...args));
  },
  qoiDecode(...args) {
    return timed('qoiDecode', () => decode$2(...args));
  },
  webpDecode(...args) {
    return timed('webpDecode', () => decode$1(...args));
  },
  wp2Decode(...args) {
    return timed('wp2Decode', () => decode(...args));
  },
  avifEncode(...args) {
    return timed('avifEncode', () => encode$6(...args));
  },
  jxlEncode(...args) {
    return timed('jxlEncode', () => encode$5(...args));
  },
  mozjpegEncode(...args) {
    return timed('mozjpegEncode', () => encode$4(...args));
  },
  oxipngEncode(...args) {
    return timed('oxipngEncode', () => encode$3(...args));
  },
  qoiEncode(...args) {
    return timed('qoiEncode', () => encode$2(...args));
  },
  webpEncode(...args) {
    return timed('webpEncode', () => encode$1(...args));
  },
  wp2Encode(...args) {
    return timed('wp2Encode', () => encode(...args));
  },
  rotate(...args) {
    return timed('rotate', () => rotate(...args));
  },
  quantize(...args) {
    return timed('quantize', () => process(...args));
  },
  resize(...args) {
